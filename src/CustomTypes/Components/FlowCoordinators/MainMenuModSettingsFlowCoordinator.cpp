        ...
        if (currentInfo)
        {
            if (!currentInfo->viewController) 
            {
                ...
                if(currentInfo->didActivateEvent)
                    currentInfo->viewController->add_didActivateEvent(custom_types::MakeDelegate<HMUI::ViewController::DidActivateDelegate*>(classof(HMUI::ViewController::DidActivateDelegate*), currentInfo->viewController, currentInfo->didActivateEvent));
            }

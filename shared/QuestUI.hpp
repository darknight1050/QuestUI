...
namespace QuestUI {
    ...
    class Register {
        public:
            ...
            template<class T>
            static void RegisterGameplaySetupMenu(ModInfo modInfo, MenuType menuType = MenuType::All) {
            ...
            /// @param menuType when to actually present this type
            template<class T>
            static void RegisterGameplaySetupMenu(ModInfo modInfo, std::string_view title, MenuType menuType = MenuType::All) {
                static_assert(std::is_convertible<T, UnityEngine::Component*>(), "Passed Type is not convertible to UnityEngine::Component!");
            ...
            static void RegisterGameplaySetupMenu(ModInfo modInfo, MenuType menuType = MenuType::All, GameplaySetupMenuEvent setupEvent = nullptr) {
            ...
            /// @param menuType when to actually present this type
            /// @param setupEvent callback called when your object is constructed
            static void RegisterGameplaySetupMenu(ModInfo modInfo, std::string_view title, MenuType menuType = MenuType::All, GameplaySetupMenuEvent setupEvent = nullptr) {
        ...
        private:
            ...
            static void RegisterGameplaySetupMenu(ModInfo modInfo, std::string_view title, Il2CppReflectionType* il2cpp_type, MenuType type, GameplaySetupMenuEvent setupEvent = nullptr);
